...
public class Postcard extends RouteMeta {
    ...
    public Object navigation() {
        return TinyRouter.getInstance().navigation(null, this, -1, null);
    }

    public Object navigation(Context context) {
        return TinyRouter.getInstance().navigation(context, this, -1, null);
    }


    public Object navigation(Context context, NavigationCallback callback) {
        return TinyRouter.getInstance().navigation(context, this, -1, callback);
    }

    public Object navigation(Context context, int requestCode) {
        return TinyRouter.getInstance().navigation(context, this, requestCode, null);
    }

    public Object navigation(Context context, int requestCode, NavigationCallback callback) {
        return TinyRouter.getInstance().navigation(context, this, requestCode, callback);
    }
